...
export function CinematicIntro({ onComplete }: CinematicIntroProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-50 flex flex-col items-center justify-center p-6 overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900"
    >
      <div className="relative z-10 flex flex-col items-center">
        ...
        <motion.p
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1 }}
          className="text-xl text-slate-200 mb-12 text-center"
        >
        ...
        <motion.p
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 3 }}
          className="text-slate-300 text-center italic"
        >
